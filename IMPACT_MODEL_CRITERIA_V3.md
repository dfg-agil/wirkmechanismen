...
- No factors (whether influencing factors, success factors, etc.) may be made up. Only the factors present in the main model may be used. This rule must not be broken at any time. The "generated by AI" criteria described in section "0.1 Information" of the file "REFERENCE_MODEL_CRITERIA_V6.md" are excluded. Exception: support-driven new influencing factors are allowed only under the strict conditions defined in section 1.4.
