# Impact Model Generation Criteria (V3)
...
- **REVIEW REQUIRED**: IM connections that deviate from the Main Model polarity for context reasons SHOULD include a short explanation in `description` or accompanying documentation.
