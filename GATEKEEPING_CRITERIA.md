...
- **Agenten-/Chat-Regel (verbindlich)**: Wenn neue Einflussfaktoren ohne beide Metriken vorgeschlagen werden, **muss** der Agent im Chat sofort ablehnen und den Hinweis geben: „Neue Faktoren nur mit Metriken – sonst kein Merge.“ Erst nach Nachlieferung der Metriken darf weitergearbeitet werden.
